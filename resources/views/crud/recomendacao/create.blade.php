    ...
    <div class="py-12">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <h1 class="text-4xl font-bold text-center text-black pt-6 mb-2">Adicionar recomendação</h1>
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{route('recomendacao.create')}}" method="POST">
                        ...
                        <div class="mb-4 w-full">
                            ...
                            <textarea name="body" id="body" class="form-textarea resize-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" cols="30" rows="10" placeholder="Recomendações"></textarea>
                        </div>
