    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <a href="/admin/comida"
                    class="text-white hover:underline bg-red-500 text-white px-4 py-2 rounded-full mb-4 flex justify-center items-center mx-auto">Voltar</a>
                <form action="{{ route('comida.create') }}" method="POST"
                    class="w-full max-w-lg mx-auto bg-white p-8 rounded-md shadow-md flex flex-col items-start">
                    @csrf()
                    ...
                    <div class="mb-4 w-full">
                        ...
                        <textarea name="body" id="body"
                            ...
                            cols="30" rows="10" placeholder="Comidas"></textarea>
                    </div>
                    <div class="mb-4 w-full">
                    ...
                    <div class="w-full">
                        <div class="text-center mt-4">
                            <button type="submit"
                                class="bg-green-500 text-white px-4 py-2 rounded-full w-full max-w-sm mx-auto text-lg">Enviar</button>
                        </div>
                    </div>
                </form>
            </div>
